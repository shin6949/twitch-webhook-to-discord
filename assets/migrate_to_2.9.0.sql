...
CREATE TABLE youtube_channel_info (
    ...
    youtube_id varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
    upload_playlist_id varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
    last_checked_time DATETIME
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

INSERT INTO youtube_channel_info (youtube_id)
...
ON YSF.channel_id = YCI.youtube_id
...
ON YNL.channel_id = YCI.youtube_id
...
CREATE VIEW youtube_subscription_group_view AS (
    SELECT channel_id AS channel_id, type AS type, enabled AS enabled
    FROM youtube_subscription_form
