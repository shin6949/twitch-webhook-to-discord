...
CREATE VIEW youtube_subscription_group_view AS (
    SELECT YCI.youtube_channel_id AS youtube_channel_id, YCI.upload_playlist_id AS upload_playlist_id,
           YCI.last_checked_time AS last_checked_time, YSF.type AS type, YSF.enabled AS enabled
