// NotificationTypeSelect.tsx
import React  from 'react';
import {Form} from 'react-bootstrap';
import { useTranslation } from "next-i18next";
import { NotificationType } from "../../utils/Register";

interface NotificationTypeSelectProps {
    notificationTypes: NotificationType[];
    selectedNotificationType: string;
    onNotificationTypeChange: (event: React.ChangeEvent<HTMLInputElement>) => void;
}
...
const NotificationTypeSelect: React.FC<NotificationTypeSelectProps> = ({
    ...
    return (
        <Form.Group controlId="formNotificationType">
            ...
            <Form.Control as="select" value={selectedNotificationType} onChange={onNotificationTypeChange}>
